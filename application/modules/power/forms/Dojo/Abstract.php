 ...
 * @author     Shaun Freeman <shaun@shaunfreeman.co.uk>
 */
class Power_Form_Dojo_Abstract extends Zend_Dojo_Form
{
    /**
    ...
    {
        $this->addPrefixPath(
        	'Power_Form_Dojo_Element',
        	APPLICATION_PATH . '/modules/power/forms/Dojo/Element',
        	'element'
        );
    ...
    {
        if (null !== $view) {
            if (false === $view->getPluginLoader('helper')->getPaths('Power_Form_Dojo_View_Helper')) {
                $view->addHelperPath(
                	APPLICATION_PATH . '/modules/power/forms/Dojo/View/Helper', 
                	'Power_Form_Dojo_View_Helper'
                );
            }
        }
