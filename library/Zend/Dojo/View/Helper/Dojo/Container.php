...
class Zend_Dojo_View_Helper_Dojo_Container
{
    ...
    /**
     * AMD Modules to require
     * @var array
     */
    protected $_amdModules = array();
    ...
    /**
     * render modules or not.
     * @var bool
     */
    protected $_renderModules = true;
     ...
     * @return Zend_Dojo_View_Helper_Dojo_Container
     */
    public function requireModule($modules, $amd = false)
    {
        ...
        foreach ($modules as $mod) {
            ...
            if ($amd) {
                if (!in_array($mod, $this->_amdModules)) {
                    $this->_amdModules[] = $mod;
                }
            } else {
    ...
    public function getModules()
    {
     ...
     /**
     * Retrieve list of amd modules to require
     *
     * @return array
     */
    public function getAmdModules()
    {
        return $this->_amdModules;
    }
     ...
     * Render modules or not
     *
     * @param bool $render true|false
     * @return Zend_Dojo_View_Helper_Dojo_Container
     */
    public function setRenderModules($render)
    {
        $this->_renderModules = (bool) $render;
        return $this;
    }
...
EOJ;
    ...
    protected function _renderExtras()
    {
        ...
        $modules = $this->getAmdModules();
        if (!empty($modules)) {
            foreach ($modules as $module) {
                $js[] = 'require(["' . $this->view->escape($module) . '"]);';
            }
        }
